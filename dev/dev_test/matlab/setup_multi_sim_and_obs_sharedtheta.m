...
function res = setup_multi_sim_and_obs_sharedtheta(m, n, nt_sim, nt_obs, noise_sd, nx, n_pc, seed, n_lik, n_mcmc, n_pred, n_shared, clist)
    ...
    if n_mcmc > 0
        tic;
        mcmc = gpmmcmc(paramout, n_mcmc, 'clist', clist);
        mcmc_time = toc;
