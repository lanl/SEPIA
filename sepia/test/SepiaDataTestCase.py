...
class SepiaDataTestCase(unittest.TestCase):
    ...
    def test_univariate_sim_only_x_only(self):
        ...
        self.assertEqual(d.sim_data.y_sd, 1)
        self.assertEqual(d.sim_data.y_mean, 0)
        self.assertTrue(np.allclose(d.sim_data.y, d.sim_data.y_std))

        d.standardize_y(scale='columnwise')
        self.assertTrue(np.allclose(d.sim_data.y_sd, 5, rtol=0.1))
        self.assertTrue(np.allclose(d.sim_data.y_mean, 2, rtol=0.1))
    ...
    def test_multivariate_sim_only_x_only(self):
        ...
        d.standardize_y(scale='columnwise')
        self.assertTrue(np.allclose(d.sim_data.y_mean, np.log(1 + y_ind), rtol=0.1, atol=0.5))
        self.assertTrue(np.allclose(np.std(d.sim_data.y_std, 0), 1, rtol=0.1))
        self.assertTrue(np.allclose(np.mean(d.sim_data.y_std, 0), 0, rtol=0.1))
        self.assertTrue(d.sim_data.y.shape == d.sim_data.y_std.shape)
    ...
    def test_univariate_sim_and_obs(self):
        ...
        self.assertEqual(d.sim_data.y_mean, 0)
        self.assertTrue(np.allclose(d.sim_data.y, d.sim_data.y_std))
        self.assertEqual(d.obs_data.y_sd, 1)
        self.assertEqual(d.obs_data.y_mean, 0)
        ...
        self.assertTrue(np.allclose(np.std(d.sim_data.y_std, 0), 1, rtol=0.1))
        self.assertTrue(d.sim_data.y.shape == d.sim_data.y_std.shape)
        self.assertTrue(np.allclose(d.obs_data.y_sd, 5, rtol=0.1))
        self.assertTrue(np.allclose(d.obs_data.y_mean, 2, rtol=0.1))
    ...
    def test_multivariate_sim_and_obs(self):
        ...
        d.standardize_y(scale='columnwise')
        self.assertTrue(np.allclose(d.sim_data.y_mean, np.log(1 + y_ind_sim), rtol=0.1, atol=0.5))
        self.assertTrue(np.allclose(np.mean(d.sim_data.y_std, 0), 0, rtol=0.1))
        self.assertTrue(np.allclose(np.std(d.sim_data.y_std, 0), 1, rtol=0.1))
        self.assertTrue(d.sim_data.y.shape == d.sim_data.y_std.shape)
        self.assertTrue(np.allclose(d.obs_data.y_mean, np.log(1 + y_ind_obs), rtol=0.1, atol=0.5))
        self.assertTrue(d.obs_data.y.shape == d.obs_data.y_std.shape)
